      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 16,),
                CustomTextFormField(hintText:AppString.confirmPassword,prefixIcon:SvgPicture.asset( AppIcon.password),suffixIcon:SvgPicture.asset( AppIcon.eyeOff),),
              SizedBox(height: 16,),
                CustomTextFormField(hintText:AppString.phone,prefixIcon:SvgPicture.asset( AppIcon.phone),),
              SizedBox(height: 16,),
              CustomElevatedButton(elevatedButtonText: AppString.createAccount,
        ...
        SizedBox(
          ...
          Row(
            ...
            children: [
              Text(AppString.alreadyHaveAccount,style: TextStyle(
